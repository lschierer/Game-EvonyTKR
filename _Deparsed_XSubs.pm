...
sub match_next;
sub new;
sub set_caseignore_slice;
sub set_deletions;
sub set_edit_distance;
sub set_greedy;
sub set_insertions;
sub set_minimal_distance;
sub set_substitutions;
sub set_text_final_position;
sub set_text_initial_position;
sub set_text_position_range;
sub slice;
sub slice_next;
}
