...
class AsyncComputed {
  ...
  #isNotified = false;
  #status = new Signal.State("initial");
  ...
  #error = new Signal.State(undefined);
  ...
  #deferred = new Signal.State(undefined);
  ...
  constructor(fn, options) {
    ...
    this.#computed = new Signal.Computed(() => {
      ...
      fn(this.#currentAbortController.signal).then(result => {
  ...
  get() {
    ...
    if (status === "error" || status === "pending" && this.error !== undefined) {
      throw this.error;
    }
    return this.value;
  }
...
//# sourceMappingURL=async-computed.ts.js.map
