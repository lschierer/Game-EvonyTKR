...
class NewtonsoftCSharpRenderer extends CSharpRenderer_1.CSharpRenderer {
    ...
    emitDecodeTransformer(xfer, targetType, emitFinish, variableName = "value") {
        ...
        if (xfer instanceof Transformers_1.DecodingChoiceTransformer) {
            this.emitDecoderSwitch(() => {
                ...
                this.emitDecoderTransformerCase(xfer.integerTransformer === undefined
                    ? ["Integer", "Float"]
                    : ["Float"], "doubleValue", xfer.doubleTransformer, targetType, emitFinish);
    ...
    emitTransformation(converterName, t) {
        ...
        this.emitType(undefined, utils_1.AccessModifier.Internal, "class", converterName, "JsonConverter", () => {
