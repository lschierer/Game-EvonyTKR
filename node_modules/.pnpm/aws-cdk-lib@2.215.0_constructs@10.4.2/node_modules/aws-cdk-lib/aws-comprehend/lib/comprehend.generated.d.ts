 ...
 */
export interface IDocumentClassifierRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnDocumentClassifier extends cdk.CfnResource implements cdk.IInspectable, IDocumentClassifierRef, cdk.ITaggableV2 {
    /**
    ...
    get documentClassifierRef(): DocumentClassifierReference;
 ...
 * @stability experimental
 */
export interface IFlywheelRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnFlywheel extends cdk.CfnResource implements cdk.IInspectable, IFlywheelRef, cdk.ITaggable {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    ...
    get flywheelRef(): FlywheelReference;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
