 ...
 */
export interface IConnectorRef extends constructs.IConstruct {
    /**
 ...
 * @stability experimental
 */
export interface IDirectoryRegistrationRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnDirectoryRegistration extends cdk.CfnResource implements cdk.IInspectable, IDirectoryRegistrationRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    ...
    get directoryRegistrationRef(): DirectoryRegistrationReference;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
 ...
 * @stability experimental
 */
export interface IServicePrincipalNameRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnServicePrincipalName extends cdk.CfnResource implements cdk.IInspectable, IServicePrincipalNameRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    ...
    get servicePrincipalNameRef(): ServicePrincipalNameReference;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
 ...
 * @stability experimental
 */
export interface ITemplateGroupAccessControlEntryRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnTemplateGroupAccessControlEntry extends cdk.CfnResource implements cdk.IInspectable, ITemplateGroupAccessControlEntryRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    ...
    get templateGroupAccessControlEntryRef(): TemplateGroupAccessControlEntryReference;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
