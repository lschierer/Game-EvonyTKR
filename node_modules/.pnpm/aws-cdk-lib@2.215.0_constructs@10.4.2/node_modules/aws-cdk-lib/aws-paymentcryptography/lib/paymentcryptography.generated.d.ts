 ...
 */
export interface IAliasRef extends constructs.IConstruct {
    /**
 ...
 * @stability experimental
 */
export interface IKeyRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnKey extends cdk.CfnResource implements cdk.IInspectable, IKeyRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
