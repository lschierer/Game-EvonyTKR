 ...
 */
export interface IEnabledControlRef extends constructs.IConstruct {
    /**
 ...
 * @stability experimental
 */
export interface IEnabledBaselineRef extends constructs.IConstruct {
    /**
 ...
 * @stability experimental
 */
export interface ILandingZoneRef extends constructs.IConstruct {
    /**
