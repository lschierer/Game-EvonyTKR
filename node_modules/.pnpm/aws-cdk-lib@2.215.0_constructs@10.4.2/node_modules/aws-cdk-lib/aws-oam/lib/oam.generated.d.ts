 ...
 */
export interface ILinkRef extends constructs.IConstruct {
    /**
 ...
 * @stability experimental
 */
export interface ISinkRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnSink extends cdk.CfnResource implements cdk.IInspectable, ISinkRef, cdk.ITaggable {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
