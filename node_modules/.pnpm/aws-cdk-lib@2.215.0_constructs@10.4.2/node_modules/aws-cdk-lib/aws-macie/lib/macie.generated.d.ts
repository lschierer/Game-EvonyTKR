 ...
 */
export interface IAllowListRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnAllowList extends cdk.CfnResource implements cdk.IInspectable, IAllowListRef, cdk.ITaggable {
    /**
    ...
    get allowListRef(): AllowListReference;
 ...
 * @stability experimental
 */
export interface ICustomDataIdentifierRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnCustomDataIdentifier extends cdk.CfnResource implements cdk.IInspectable, ICustomDataIdentifierRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    ...
    get customDataIdentifierRef(): CustomDataIdentifierReference;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
 ...
 * @stability experimental
 */
export interface IFindingsFilterRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnFindingsFilter extends cdk.CfnResource implements cdk.IInspectable, IFindingsFilterRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    ...
    get findingsFilterRef(): FindingsFilterReference;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
 ...
 * @stability experimental
 */
export interface ISessionRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnSession extends cdk.CfnResource implements cdk.IInspectable, ISessionRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
     ...
     */
    readonly attrAutomatedDiscoveryStatus: string;
    /**
    ...
    get sessionRef(): SessionReference;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
