 ...
 */
export interface IApplicationInstanceRef extends constructs.IConstruct {
    /**
 ...
 * @stability experimental
 */
export interface IPackageRef extends constructs.IConstruct {
    /**
 ...
 * @stability experimental
 */
export interface IPackageVersionRef extends constructs.IConstruct {
    /**
