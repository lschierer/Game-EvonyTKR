 ...
 */
export interface IReplicationSetRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnReplicationSet extends cdk.CfnResource implements cdk.IInspectable, IReplicationSetRef, cdk.ITaggable {
    /**
    ...
    get replicationSetRef(): ReplicationSetReference;
 ...
 * @stability experimental
 */
export interface IResponsePlanRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnResponsePlan extends cdk.CfnResource implements cdk.IInspectable, IResponsePlanRef, cdk.ITaggable {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    ...
    get responsePlanRef(): ResponsePlanReference;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
