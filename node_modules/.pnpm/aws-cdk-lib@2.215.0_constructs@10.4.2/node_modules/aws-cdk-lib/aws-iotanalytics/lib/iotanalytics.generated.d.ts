 ...
 * @stability experimental
 */
export interface IDatastoreRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnDatastore extends cdk.CfnResource implements cdk.IInspectable, IDatastoreRef, cdk.ITaggable {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
