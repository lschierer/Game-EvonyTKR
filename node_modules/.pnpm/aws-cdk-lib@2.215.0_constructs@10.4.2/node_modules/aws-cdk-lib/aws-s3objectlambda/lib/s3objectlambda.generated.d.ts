 ...
 * @stability experimental
 */
export interface IAccessPointPolicyRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnAccessPointPolicy extends cdk.CfnResource implements cdk.IInspectable, IAccessPointPolicyRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    ...
    get accessPointPolicyRef(): AccessPointPolicyReference;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
