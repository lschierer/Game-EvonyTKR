 ...
 */
export interface IApiDestinationRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnApiDestination extends cdk.CfnResource implements cdk.IInspectable, IApiDestinationRef {
    /**
 ...
 * @stability experimental
 */
export interface IArchiveRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnArchive extends cdk.CfnResource implements cdk.IInspectable, IArchiveRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    ...
    get archiveRef(): ArchiveReference;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
 ...
 * @stability experimental
 */
export interface IEventBusRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnEventBus extends cdk.CfnResource implements cdk.IInspectable, IEventBusRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
     ...
     */
    logConfig?: cdk.IResolvable | CfnEventBus.LogConfigProperty;
    /**
...
export interface CfnEventBusProps {
     ...
     */
    readonly logConfig?: cdk.IResolvable | CfnEventBus.LogConfigProperty;
    /**
     * The name of the new event bus.
     *
 ...
 * @stability experimental
 */
export interface IEventBusPolicyRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnEventBusPolicy extends cdk.CfnResource implements cdk.IInspectable, IEventBusPolicyRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    ...
    get eventBusPolicyRef(): EventBusPolicyReference;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
