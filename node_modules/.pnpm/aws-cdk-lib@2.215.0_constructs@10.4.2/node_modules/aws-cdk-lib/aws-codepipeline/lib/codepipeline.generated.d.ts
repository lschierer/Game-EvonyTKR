 ...
 */
export interface ICustomActionTypeRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnCustomActionType extends cdk.CfnResource implements cdk.IInspectable, ICustomActionTypeRef, cdk.ITaggable {
    /**
    ...
    get customActionTypeRef(): CustomActionTypeReference;
...
export declare namespace CfnPipeline {
    ...
    interface ActionDeclarationProperty {
         ...
         */
        readonly environmentVariables?: Array<CfnPipeline.EnvironmentVariableProperty | cdk.IResolvable> | cdk.IResolvable;
        /**
 ...
 * @stability experimental
 */
export interface IWebhookRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnWebhook extends cdk.CfnResource implements cdk.IInspectable, IWebhookRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    ...
    get webhookRef(): WebhookReference;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
