 ...
 */
export interface IGrantRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnGrant extends cdk.CfnResource implements cdk.IInspectable, IGrantRef {
    /**
 ...
 * @stability experimental
 */
export interface ILicenseRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnLicense extends cdk.CfnResource implements cdk.IInspectable, ILicenseRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
