 ...
 * @stability experimental
 */
export interface ILiveSourceRef extends constructs.IConstruct {
    /**
 ...
 * @stability experimental
 */
export interface IPlaybackConfigurationRef extends constructs.IConstruct {
    /**
...
export declare class CfnPlaybackConfiguration extends cdk.CfnResource implements cdk.IInspectable, IPlaybackConfigurationRef, cdk.ITaggable {
     ...
     */
    adConditioningConfiguration?: CfnPlaybackConfiguration.AdConditioningConfigurationProperty | cdk.IResolvable;
    /**
     ...
     */
    logConfiguration?: cdk.IResolvable | CfnPlaybackConfiguration.LogConfigurationProperty;
    /**
...
export declare namespace CfnPlaybackConfiguration {
    ...
    interface LogConfigurationProperty {
         ...
         */
        readonly adsInteractionLog?: CfnPlaybackConfiguration.AdsInteractionLogProperty | cdk.IResolvable;
        /**
         ...
         */
        readonly manifestServiceInteractionLog?: cdk.IResolvable | CfnPlaybackConfiguration.ManifestServiceInteractionLogProperty;
        /**
...
export interface CfnPlaybackConfigurationProps {
     ...
     */
    readonly adConditioningConfiguration?: CfnPlaybackConfiguration.AdConditioningConfigurationProperty | cdk.IResolvable;
    /**
     * The URL for the ad decision server (ADS).
     *
     * This includes the specification of static parameters and placeholders for dynamic parameters. AWS Elemental MediaTailor substitutes player-specific and session-specific parameters as needed when calling the ADS. Alternately, for testing you can provide a static VAST URL. The maximum length is 25,000 characters.
     ...
     */
    readonly logConfiguration?: cdk.IResolvable | CfnPlaybackConfiguration.LogConfigurationProperty;
    /**
     * The configuration for manifest processing rules.
     *
     * Manifest processing rules enable customization of the personalized manifests created by MediaTailor.
 ...
 * @stability experimental
 */
export interface ISourceLocationRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnSourceLocation extends cdk.CfnResource implements cdk.IInspectable, ISourceLocationRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    ...
    get sourceLocationRef(): SourceLocationReference;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
 ...
 * @stability experimental
 */
export interface IVodSourceRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnVodSource extends cdk.CfnResource implements cdk.IInspectable, IVodSourceRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    ...
    get vodSourceRef(): VodSourceReference;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
