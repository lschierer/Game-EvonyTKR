 ...
 */
export interface IGlobalTableRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnGlobalTable extends cdk.CfnResource implements cdk.IInspectable, IGlobalTableRef {
    /**
     ...
     */
    globalTableWitnesses?: Array<CfnGlobalTable.GlobalTableWitnessProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
    ...
    get globalTableRef(): GlobalTableReference;
...
export interface CfnGlobalTableProps {
     ...
     */
    readonly globalTableWitnesses?: Array<CfnGlobalTable.GlobalTableWitnessProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
     * Specifies the attributes that make up the primary key for the table.
     *
