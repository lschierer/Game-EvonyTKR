 ...
 */
export interface IKeyspaceRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnKeyspace extends cdk.CfnResource implements cdk.IInspectable, IKeyspaceRef, cdk.ITaggable {
    /**
    ...
    get keyspaceRef(): KeyspaceReference;
...
export declare class CfnTable extends cdk.CfnResource implements cdk.IInspectable, ITableRef, cdk.ITaggable {
     ...
     */
    cdcSpecification?: CfnTable.CdcSpecificationProperty | cdk.IResolvable;
    /**
...
export interface CfnTableProps {
     ...
     */
    readonly cdcSpecification?: CfnTable.CdcSpecificationProperty | cdk.IResolvable;
    /**
     * Enables client-side timestamps for the table.
     *
 ...
 * @stability experimental
 */
export interface ITypeRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnType extends cdk.CfnResource implements cdk.IInspectable, ITypeRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
