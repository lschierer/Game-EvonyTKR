...
export declare class Project extends ProjectBase {
     ...
     */
    private validateLambdaBuildImage;
}
/**
...
export declare class LinuxBuildImage implements IBuildImage {
    ...
    static readonly AMAZON_LINUX_2023_4: IBuildImage;
    /** The Amazon Linux 2023 x86_64 standard image, version `5.0`. */
    static readonly AMAZON_LINUX_2023_5: IBuildImage;
    /** The Amazon Coretto 8 image x86_64, based on Amazon Linux 2. */
    static readonly AMAZON_LINUX_2_CORETTO_8: IBuildImage;
    /** The Amazon Coretto 11 image x86_64, based on Amazon Linux 2. */
    static readonly AMAZON_LINUX_2_CORETTO_11: IBuildImage;
    /** The Amazon Coretto 8 image x86_64, based on Amazon Linux 2023. */
    static readonly AMAZON_LINUX_2023_CORETTO_8: IBuildImage;
...
export declare class WindowsBuildImage implements IBuildImage {
     ...
     * based off Windows Server Core 2019.
     */
    static readonly WIN_SERVER_CORE_2019_BASE_3_0: IBuildImage;
    /**
     ...
     * @see https://docs.aws.amazon.com/codebuild/latest/userguide/fleets.html
     */
    static readonly WIN_SERVER_CORE_2022_BASE_3_0: IBuildImage;
    /**
 ...
 * @see https://docs.aws.amazon.com/codebuild/latest/userguide/build-env-ref-available.html
 */
export declare class MacBuildImage implements IBuildImage {
    /**
     * Corresponds to the standard CodeBuild image `aws/codebuild/macos-arm-base:14`.
     */
    static readonly BASE_14: IBuildImage;
    /**
