 ...
 * @stability experimental
 */
export interface ILoggingConfigurationRef extends constructs.IConstruct {
    /**
 ...
 * @stability experimental
 */
export interface IRegexPatternSetRef extends constructs.IConstruct {
    /**
 ...
 * @stability experimental
 */
export interface IRuleGroupRef extends constructs.IConstruct {
    /**
...
export declare namespace CfnRuleGroup {
    ...
    interface StatementProperty {
         ...
         */
        readonly asnMatchStatement?: CfnRuleGroup.AsnMatchStatementProperty | cdk.IResolvable;
        /**
    ...
    interface FieldToMatchProperty {
         ...
         */
        readonly uriFragment?: cdk.IResolvable | CfnRuleGroup.UriFragmentProperty;
        /**
    ...
    interface RateBasedStatementCustomKeyProperty {
         ...
         */
        readonly asn?: any | cdk.IResolvable;
        /**
    ...
    interface AsnMatchStatementProperty {
         ...
         */
        readonly asnList?: Array<number> | cdk.IResolvable;
        /**
 ...
 */
export declare class CfnWebACL extends cdk.CfnResource implements cdk.IInspectable, IWebACLRef, cdk.ITaggable {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
     ...
     */
    dataProtectionConfig?: CfnWebACL.DataProtectionConfigProperty | cdk.IResolvable;
    /**
     ...
     */
    onSourceDDoSProtectionConfig?: cdk.IResolvable | CfnWebACL.OnSourceDDoSProtectionConfigProperty;
    /**
...
export declare namespace CfnWebACL {
    ...
    interface StatementProperty {
         ...
         */
        readonly asnMatchStatement?: CfnWebACL.AsnMatchStatementProperty | cdk.IResolvable;
        /**
         * A rule statement that defines a string match search for AWS WAF to apply to web requests.
         *
         * The byte match statement provides the bytes to search for, the location in requests that you want AWS WAF to search, and other settings. The bytes to search for are typically a string that corresponds with ASCII characters. In the AWS WAF console and the developer guide, this is called a string match statement.
    ...
    interface FieldToMatchProperty {
         ...
         */
        readonly uriFragment?: cdk.IResolvable | CfnWebACL.UriFragmentProperty;
        /**
         * Inspect the request URI path.
         *
         * This is the part of the web request that identifies a resource, for example, `/images/daily-ad.jpg` .
    ...
    interface ManagedRuleGroupConfigProperty {
         ...
         */
        readonly awsManagedRulesAntiDDoSRuleSet?: CfnWebACL.AWSManagedRulesAntiDDoSRuleSetProperty | cdk.IResolvable;
        /**
    ...
    interface AWSManagedRulesAntiDDoSRuleSetProperty {
         ...
         */
        readonly clientSideActionConfig: CfnWebACL.ClientSideActionConfigProperty | cdk.IResolvable;
        /**
    ...
    interface ClientSideActionConfigProperty {
         ...
         */
        readonly challenge: CfnWebACL.ClientSideActionProperty | cdk.IResolvable;
    }
    /**
    ...
    interface ClientSideActionProperty {
         ...
         */
        readonly exemptUriRegularExpressions?: Array<cdk.IResolvable | CfnWebACL.RegexProperty> | cdk.IResolvable;
        /**
    ...
    interface DataProtectionConfigProperty {
         ...
         */
        readonly dataProtections: Array<CfnWebACL.DataProtectProperty | cdk.IResolvable> | cdk.IResolvable;
    }
    /**
     * @struct
     * @stability external
    ...
    interface DataProtectProperty {
         ...
         */
        readonly excludeRateBasedDetails?: boolean | cdk.IResolvable;
        /**
         ...
         */
        readonly excludeRuleMatchDetails?: boolean | cdk.IResolvable;
        /**
         ...
         */
        readonly field: CfnWebACL.FieldToProtectProperty | cdk.IResolvable;
    }
    /**
    ...
    interface OnSourceDDoSProtectionConfigProperty {
         ...
         */
        readonly albLowReputationMode: string;
    }
    /**
     * Inspect one of the headers in the web request, identified by name, for example, `User-Agent` or `Referer` .
     *
...
export interface CfnWebACLProps {
     ...
     */
    readonly dataProtectionConfig?: CfnWebACL.DataProtectionConfigProperty | cdk.IResolvable;
    /**
     * The action to perform if none of the `Rules` contained in the `WebACL` match.
     *
     ...
     */
    readonly onSourceDDoSProtectionConfig?: cdk.IResolvable | CfnWebACL.OnSourceDDoSProtectionConfigProperty;
    /**
     * The rule statements used to identify the web requests that you want to manage.
     *
     * Each rule includes one top-level statement that AWS WAF uses to identify matching web requests, and parameters that govern how AWS WAF handles them.
 ...
 * @stability experimental
 */
export interface IWebACLAssociationRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnWebACLAssociation extends cdk.CfnResource implements cdk.IInspectable, IWebACLAssociationRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    ...
    get webAclAssociationRef(): WebACLAssociationReference;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
