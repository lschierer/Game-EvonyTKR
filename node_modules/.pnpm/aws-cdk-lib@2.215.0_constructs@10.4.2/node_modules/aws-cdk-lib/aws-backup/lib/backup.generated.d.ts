 ...
 */
export declare class CfnBackupPlan extends cdk.CfnResource implements cdk.IInspectable, IBackupPlanRef, cdk.ITaggableV2 {
    /**
 ...
 */
export declare class CfnBackupSelection extends cdk.CfnResource implements cdk.IInspectable, IBackupSelectionRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    ...
    get backupSelectionRef(): BackupSelectionReference;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
 ...
 */
export declare class CfnBackupVault extends cdk.CfnResource implements cdk.IInspectable, IBackupVaultRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
 ...
 */
export declare class CfnFramework extends cdk.CfnResource implements cdk.IInspectable, IFrameworkRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    ...
    get frameworkRef(): FrameworkReference;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
 ...
 */
export declare class CfnReportPlan extends cdk.CfnResource implements cdk.IInspectable, IReportPlanRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    ...
    get reportPlanRef(): ReportPlanReference;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
 ...
 */
export declare class CfnLogicallyAirGappedBackupVault extends cdk.CfnResource implements cdk.IInspectable, ILogicallyAirGappedBackupVaultRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnLogicallyAirGappedBackupVault from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnLogicallyAirGappedBackupVault;
    /**
     ...
     */
    readonly attrVaultType: string;
    /**
     * The backup vault access policy document in JSON format.
     */
    accessPolicy?: any | cdk.IResolvable | string;
    /**
     * The name of a logical container where backups are stored.
     */
    backupVaultName: string;
     ...
     */
    notifications?: cdk.IResolvable | CfnLogicallyAirGappedBackupVault.NotificationObjectTypeProperty;
    /**
     * @param scope Scope in which this resource is defined
     * @param id Construct identifier for this resource (unique in its scope)
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnLogicallyAirGappedBackupVaultProps);
    get logicallyAirGappedBackupVaultRef(): LogicallyAirGappedBackupVaultReference;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare namespace CfnLogicallyAirGappedBackupVault {
    /**
     * @struct
     * @stability external
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-backup-logicallyairgappedbackupvault.html
 */
export interface CfnLogicallyAirGappedBackupVaultProps {
    /**
     * The backup vault access policy document in JSON format.
     *
     ...
     */
    readonly accessPolicy?: any | cdk.IResolvable | string;
    /**
     * The name of a logical container where backups are stored.
     *
     ...
     */
    readonly notifications?: cdk.IResolvable | CfnLogicallyAirGappedBackupVault.NotificationObjectTypeProperty;
}
/**
 * A reference to a LogicallyAirGappedBackupVault resource.
 *
 ...
 */
export declare class CfnRestoreTestingPlan extends cdk.CfnResource implements cdk.IInspectable, IRestoreTestingPlanRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    ...
    get restoreTestingPlanRef(): RestoreTestingPlanReference;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
 ...
 */
export declare class CfnRestoreTestingSelection extends cdk.CfnResource implements cdk.IInspectable, IRestoreTestingSelectionRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    ...
    get restoreTestingSelectionRef(): RestoreTestingSelectionReference;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
