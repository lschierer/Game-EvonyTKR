...
export declare class Stack extends Construct implements ITaggable {
     ...
     */
    static isStack(this: void, x: any): x is Stack;
    /**
     ...
     * @internal
     */
    readonly _notificationArns?: string[];
    /**
     ...
     * @default - the value of `@aws-cdk/core:suppressTemplateIndentation`, or `false` if that is not set.
     */
    private readonly _suppressTemplateIndentation;
     ...
     */
    toJsonString(this: void, obj: any, space?: number): string;
    /**
     ...
     * @internal
     */
    _synthesizeTemplate(session: ISynthesisSession, lookupRoleArn?: string, lookupRoleExternalId?: string, lookupRoleAdditionalOptions?: {
        [key: string]: any;
    }): void;
    /**
     ...
     */
    addStackTag(tagName: string, tagValue: string): void;
    /**
     * Remove a stack tag
     *
     * At deploy time, CloudFormation will automatically apply all stack tags to all resources in the stack.
     */
    removeStackTag(tagName: string): void;
}
/**
