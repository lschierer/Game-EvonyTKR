...
import { IResolvable, DefaultTokenResolver, IFragmentConcatenator } from '../resolvable';
 ...
 *
 */
export declare class PolicySynthesizerTokenResolver extends DefaultTokenResolver {
     ...
     */
    resolveToken(t: IResolvable, context: any, postProcessor: any): any;
}
/**
