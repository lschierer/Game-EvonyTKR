 ...
 */
export interface IReportDefinitionRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnReportDefinition extends cdk.CfnResource implements cdk.IInspectable, IReportDefinitionRef {
    /**
