 ...
 */
export interface IEnvironmentAccountConnectionRef extends constructs.IConstruct {
    /**
 ...
 * @stability experimental
 */
export interface IEnvironmentTemplateRef extends constructs.IConstruct {
    /**
 ...
 * @stability experimental
 */
export interface IServiceTemplateRef extends constructs.IConstruct {
    /**
