 ...
 * @stability experimental
 */
export interface IDatasetGroupRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnDatasetGroup extends cdk.CfnResource implements cdk.IInspectable, IDatasetGroupRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
 ...
 */
export declare class CfnSchema extends cdk.CfnResource implements cdk.IInspectable, ISchemaRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
 ...
 * @stability experimental
 */
export interface ISolutionRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnSolution extends cdk.CfnResource implements cdk.IInspectable, ISolutionRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    ...
    get solutionRef(): SolutionReference;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
