 ...
 */
export interface IContactRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnContact extends cdk.CfnResource implements cdk.IInspectable, IContactRef, cdk.ITaggableV2 {
    /**
    ...
    get contactRef(): ContactReference;
 ...
 * @stability experimental
 */
export interface IContactChannelRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnContactChannel extends cdk.CfnResource implements cdk.IInspectable, IContactChannelRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    ...
    get contactChannelRef(): ContactChannelReference;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
 ...
 * @stability experimental
 */
export interface IPlanRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnPlan extends cdk.CfnResource implements cdk.IInspectable, IPlanRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
 ...
 * @stability experimental
 */
export interface IRotationRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnRotation extends cdk.CfnResource implements cdk.IInspectable, IRotationRef, cdk.ITaggable {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    ...
    get rotationRef(): RotationReference;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
