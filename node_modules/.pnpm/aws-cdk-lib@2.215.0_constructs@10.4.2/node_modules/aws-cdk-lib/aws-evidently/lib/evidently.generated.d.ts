 ...
 */
export interface IExperimentRef extends constructs.IConstruct {
    /**
 ...
 * @stability experimental
 */
export interface IFeatureRef extends constructs.IConstruct {
    /**
 ...
 * @stability experimental
 */
export interface ILaunchRef extends constructs.IConstruct {
    /**
 ...
 * @stability experimental
 */
export interface ISegmentRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnSegment extends cdk.CfnResource implements cdk.IInspectable, ISegmentRef, cdk.ITaggable {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    ...
    get segmentRef(): SegmentReference;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
