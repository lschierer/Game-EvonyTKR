 ...
 */
export interface IConnectionRef extends constructs.IConstruct {
    /**
 ...
 * @stability experimental
 */
export interface IRepositoryLinkRef extends constructs.IConstruct {
    /**
 ...
 * @stability experimental
 */
export interface ISyncConfigurationRef extends constructs.IConstruct {
    /**
