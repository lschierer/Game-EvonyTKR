 ...
 */
export interface IPublicRepositoryRef extends constructs.IConstruct {
    /**
 ...
 * @stability experimental
 */
export interface IPullThroughCacheRuleRef extends constructs.IConstruct {
    /**
 ...
 * @stability experimental
 */
export interface IReplicationConfigurationRef extends constructs.IConstruct {
    /**
 ...
 * @stability experimental
 */
export interface IRegistryScanningConfigurationRef extends constructs.IConstruct {
    /**
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ecr-registryscanningconfiguration.html
 */
export interface CfnRegistryScanningConfigurationProps {
    /**
     * The scanning rules associated with the registry.
     *
     ...
     */
    readonly rules: Array<cdk.IResolvable | CfnRegistryScanningConfiguration.ScanningRuleProperty> | cdk.IResolvable;
    /**
     * The type of scanning configured for the registry.
     *
 ...
 * @stability experimental
 */
export interface IRepositoryCreationTemplateRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnRepositoryCreationTemplate extends cdk.CfnResource implements cdk.IInspectable, IRepositoryCreationTemplateRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
     ...
     */
    imageTagMutabilityExclusionFilters?: Array<CfnRepositoryCreationTemplate.ImageTagMutabilityExclusionFilterProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
    ...
    get repositoryCreationTemplateRef(): RepositoryCreationTemplateReference;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export interface CfnRepositoryCreationTemplateProps {
     ...
     */
    readonly imageTagMutabilityExclusionFilters?: Array<CfnRepositoryCreationTemplate.ImageTagMutabilityExclusionFilterProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
     * The lifecycle policy to use for repositories created using the template.
     *
