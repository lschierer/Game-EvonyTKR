 ...
 */
export declare class CfnDataSource extends cdk.CfnResource implements cdk.IInspectable, IDataSourceRef, cdk.ITaggable {
    /**
 ...
 * @stability experimental
 */
export interface IFaqRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnFaq extends cdk.CfnResource implements cdk.IInspectable, IFaqRef, cdk.ITaggable {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
