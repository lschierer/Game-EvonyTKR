 ...
 */
export interface IAcceleratorRef extends constructs.IConstruct {
    /**
 ...
 * @stability experimental
 */
export interface IEndpointGroupRef extends constructs.IConstruct {
    /**
 ...
 * @stability experimental
 */
export interface ICrossAccountAttachmentRef extends constructs.IConstruct {
    /**
