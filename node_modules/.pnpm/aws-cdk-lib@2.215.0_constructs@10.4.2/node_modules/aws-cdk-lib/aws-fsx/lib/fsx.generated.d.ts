 ...
 */
export interface IDataRepositoryAssociationRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnDataRepositoryAssociation extends cdk.CfnResource implements cdk.IInspectable, IDataRepositoryAssociationRef, cdk.ITaggable {
    /**
    ...
    get dataRepositoryAssociationRef(): DataRepositoryAssociationReference;
 ...
 */
export declare class CfnFileSystem extends cdk.CfnResource implements cdk.IInspectable, IFileSystemRef, cdk.ITaggable {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
...
export declare namespace CfnFileSystem {
    ...
    interface LustreConfigurationProperty {
         ...
         */
        readonly dataReadCacheConfiguration?: CfnFileSystem.DataReadCacheConfigurationProperty | cdk.IResolvable;
        /**
 ...
 */
export declare class CfnSnapshot extends cdk.CfnResource implements cdk.IInspectable, ISnapshotRef, cdk.ITaggable {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
 ...
 */
export declare class CfnStorageVirtualMachine extends cdk.CfnResource implements cdk.IInspectable, IStorageVirtualMachineRef, cdk.ITaggable {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    ...
    get storageVirtualMachineRef(): StorageVirtualMachineReference;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
 ...
 */
export declare class CfnVolume extends cdk.CfnResource implements cdk.IInspectable, IVolumeRef, cdk.ITaggable {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
 ...
 */
export declare class CfnS3AccessPointAttachment extends cdk.CfnResource implements cdk.IInspectable, IS3AccessPointAttachmentRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnS3AccessPointAttachment from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnS3AccessPointAttachment;
    /**
     * The S3 access point's alias.
     *
     * @cloudformationAttribute S3AccessPoint.Alias
     */
    readonly attrS3AccessPointAlias: string;
    /**
     * The S3 access point's ARN.
     *
     * @cloudformationAttribute S3AccessPoint.ResourceARN
     */
    readonly attrS3AccessPointResourceArn: string;
    /**
     ...
     */
    openZfsConfiguration: cdk.IResolvable | CfnS3AccessPointAttachment.S3AccessPointOpenZFSConfigurationProperty;
    /**
     * The S3 access point configuration of the S3 access point attachment.
     */
    s3AccessPoint?: cdk.IResolvable | CfnS3AccessPointAttachment.S3AccessPointProperty;
    /**
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnS3AccessPointAttachmentProps);
    get s3AccessPointAttachmentRef(): S3AccessPointAttachmentReference;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare namespace CfnS3AccessPointAttachment {
    /**
    ...
    interface S3AccessPointOpenZFSConfigurationProperty {
         ...
         */
        readonly fileSystemIdentity: cdk.IResolvable | CfnS3AccessPointAttachment.OpenZFSFileSystemIdentityProperty;
        /**
    ...
    interface OpenZFSFileSystemIdentityProperty {
         ...
         */
        readonly posixUser: cdk.IResolvable | CfnS3AccessPointAttachment.OpenZFSPosixFileSystemUserProperty;
        /**
    ...
    interface OpenZFSPosixFileSystemUserProperty {
         ...
         */
        readonly secondaryGids?: Array<CfnS3AccessPointAttachment.FileSystemGIDProperty | cdk.IResolvable> | cdk.IResolvable;
        /**
    ...
    interface S3AccessPointProperty {
         ...
         */
        readonly vpcConfiguration?: cdk.IResolvable | CfnS3AccessPointAttachment.S3AccessPointVpcConfigurationProperty;
    }
    /**
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-fsx-s3accesspointattachment.html
 */
export interface CfnS3AccessPointAttachmentProps {
    /**
     * The name of the S3 access point attachment;
     *
     ...
     */
    readonly openZfsConfiguration: cdk.IResolvable | CfnS3AccessPointAttachment.S3AccessPointOpenZFSConfigurationProperty;
    /**
     * The S3 access point configuration of the S3 access point attachment.
     *
     ...
     */
    readonly s3AccessPoint?: cdk.IResolvable | CfnS3AccessPointAttachment.S3AccessPointProperty;
    /**
     * The type of Amazon FSx volume that the S3 access point is attached to.
     *
