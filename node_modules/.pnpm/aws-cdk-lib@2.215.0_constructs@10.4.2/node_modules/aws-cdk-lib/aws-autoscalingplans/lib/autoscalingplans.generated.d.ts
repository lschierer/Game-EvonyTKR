 ...
 */
export interface IScalingPlanRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnScalingPlan extends cdk.CfnResource implements cdk.IInspectable, IScalingPlanRef {
    /**
     ...
     */
    scalingInstructions: Array<cdk.IResolvable | CfnScalingPlan.ScalingInstructionProperty> | cdk.IResolvable;
    /**
    ...
    get scalingPlanRef(): ScalingPlanReference;
