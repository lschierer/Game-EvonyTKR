 ...
 * @stability experimental
 */
export interface ICodeSigningConfigRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnCodeSigningConfig extends cdk.CfnResource implements cdk.IInspectable, ICodeSigningConfigRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
 ...
 * @stability experimental
 */
export interface IEventInvokeConfigRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnEventInvokeConfig extends cdk.CfnResource implements cdk.IInspectable, IEventInvokeConfigRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    ...
    get eventInvokeConfigRef(): EventInvokeConfigReference;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
 ...
 * @stability experimental
 */
export interface IEventSourceMappingRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnEventSourceMapping extends cdk.CfnResource implements cdk.IInspectable, IEventSourceMappingRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
...
export declare namespace CfnEventSourceMapping {
    ...
    interface SelfManagedKafkaEventSourceConfigProperty {
         ...
         */
        readonly schemaRegistryConfig?: cdk.IResolvable | CfnEventSourceMapping.SchemaRegistryConfigProperty;
    }
    /**
     * Specific configuration settings for a Kafka schema registry.
     *
    ...
    interface SchemaRegistryConfigProperty {
         ...
         */
        readonly accessConfigs?: Array<cdk.IResolvable | CfnEventSourceMapping.SchemaRegistryAccessConfigProperty> | cdk.IResolvable;
        /**
         ...
         */
        readonly schemaValidationConfigs?: Array<cdk.IResolvable | CfnEventSourceMapping.SchemaValidationConfigProperty> | cdk.IResolvable;
    }
    /**
 ...
 * @stability experimental
 */
export interface ILayerVersionPermissionRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnLayerVersionPermission extends cdk.CfnResource implements cdk.IInspectable, ILayerVersionPermissionRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    ...
    get layerVersionPermissionRef(): LayerVersionPermissionReference;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
 ...
 * @stability experimental
 */
export interface IUrlRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnUrl extends cdk.CfnResource implements cdk.IInspectable, IUrlRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
 ...
 * @stability experimental
 */
export interface IVersionRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnVersion extends cdk.CfnResource implements cdk.IInspectable, IVersionRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
