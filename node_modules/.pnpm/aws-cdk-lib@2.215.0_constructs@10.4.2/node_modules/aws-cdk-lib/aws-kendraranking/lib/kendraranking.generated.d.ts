 ...
 */
export interface IExecutionPlanRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnExecutionPlan extends cdk.CfnResource implements cdk.IInspectable, IExecutionPlanRef, cdk.ITaggable {
    /**
    ...
    get executionPlanRef(): ExecutionPlanReference;
