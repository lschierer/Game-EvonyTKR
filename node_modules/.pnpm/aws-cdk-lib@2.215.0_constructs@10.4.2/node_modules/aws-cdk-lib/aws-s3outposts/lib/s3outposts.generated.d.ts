 ...
 */
export interface IAccessPointRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnAccessPoint extends cdk.CfnResource implements cdk.IInspectable, IAccessPointRef {
    /**
 ...
 * @stability experimental
 */
export interface IBucketPolicyRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnBucketPolicy extends cdk.CfnResource implements cdk.IInspectable, IBucketPolicyRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    ...
    get bucketPolicyRef(): BucketPolicyReference;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
 ...
 */
export declare class CfnEndpoint extends cdk.CfnResource implements cdk.IInspectable, IEndpointRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
