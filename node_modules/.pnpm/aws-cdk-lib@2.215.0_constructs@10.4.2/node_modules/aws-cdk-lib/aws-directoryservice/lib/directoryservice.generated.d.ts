 ...
 */
export interface IMicrosoftADRef extends constructs.IConstruct {
    /**
 ...
 * @stability experimental
 */
export interface ISimpleADRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnSimpleAD extends cdk.CfnResource implements cdk.IInspectable, ISimpleADRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
