...
import { CommonTaskDefinitionAttributes, CommonTaskDefinitionProps, InferenceAccelerator, IpcMode, ITaskDefinition, NetworkMode, PidMode, TaskDefinition } from '../base/task-definition';
