 ...
 * @stability experimental
 */
export interface ITagSyncTaskRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnTagSyncTask extends cdk.CfnResource implements cdk.IInspectable, ITagSyncTaskRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    ...
    get tagSyncTaskRef(): TagSyncTaskReference;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
