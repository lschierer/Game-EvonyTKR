 ...
 */
export interface ILogAnomalyDetectionIntegrationRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnLogAnomalyDetectionIntegration extends cdk.CfnResource implements cdk.IInspectable, ILogAnomalyDetectionIntegrationRef {
    /**
    ...
    get logAnomalyDetectionIntegrationRef(): LogAnomalyDetectionIntegrationReference;
 ...
 * @stability experimental
 */
export interface INotificationChannelRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnNotificationChannel extends cdk.CfnResource implements cdk.IInspectable, INotificationChannelRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    ...
    get notificationChannelRef(): NotificationChannelReference;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
 ...
 * @stability experimental
 */
export interface IResourceCollectionRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnResourceCollection extends cdk.CfnResource implements cdk.IInspectable, IResourceCollectionRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    ...
    get resourceCollectionRef(): ResourceCollectionReference;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
