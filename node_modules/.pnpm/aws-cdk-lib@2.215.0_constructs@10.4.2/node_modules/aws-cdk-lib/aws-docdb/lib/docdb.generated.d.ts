 ...
 */
export interface IDBClusterRef extends constructs.IConstruct {
    /**
 ...
 * @stability experimental
 */
export interface IDBClusterParameterGroupRef extends constructs.IConstruct {
    /**
 ...
 * @stability experimental
 */
export interface IDBInstanceRef extends constructs.IConstruct {
    /**
 ...
 * @stability experimental
 */
export interface IDBSubnetGroupRef extends constructs.IConstruct {
    /**
 ...
 * @stability experimental
 */
export interface IEventSubscriptionRef extends constructs.IConstruct {
    /**
