 ...
 */
export interface IAccessorRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnAccessor extends cdk.CfnResource implements cdk.IInspectable, IAccessorRef, cdk.ITaggable {
    /**
    ...
    get accessorRef(): AccessorReference;
 ...
 * @stability experimental
 */
export interface IMemberRef extends constructs.IConstruct {
    /**
 ...
 * @stability experimental
 */
export interface INodeRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnNode extends cdk.CfnResource implements cdk.IInspectable, INodeRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
