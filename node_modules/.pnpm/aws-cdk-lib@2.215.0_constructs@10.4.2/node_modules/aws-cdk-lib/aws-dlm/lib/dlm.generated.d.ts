 ...
 */
export declare class CfnLifecyclePolicy extends cdk.CfnResource implements cdk.IInspectable, ILifecyclePolicyRef, cdk.ITaggable {
    /**
...
export declare namespace CfnLifecyclePolicy {
    ...
    interface CreateRuleProperty {
         ...
         *
         * The schedule interval must be between 1 hour and 1 year. For more information, see the [Cron and rate expressions](https://docs.aws.amazon.com/eventbridge/latest/userguide/eb-scheduled-rule-pattern.html) in the *Amazon EventBridge User Guide* .
         *
