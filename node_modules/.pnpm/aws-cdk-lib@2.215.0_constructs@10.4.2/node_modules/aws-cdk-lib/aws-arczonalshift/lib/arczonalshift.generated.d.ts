 ...
 */
export interface IAutoshiftObserverNotificationStatusRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnAutoshiftObserverNotificationStatus extends cdk.CfnResource implements cdk.IInspectable, IAutoshiftObserverNotificationStatusRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnAutoshiftObserverNotificationStatus from CloudFormation properties
     *
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnAutoshiftObserverNotificationStatus;
    /**
     ...
     */
    constructor(scope: constructs.Construct, id: string, props: CfnAutoshiftObserverNotificationStatusProps);
    get autoshiftObserverNotificationStatusRef(): AutoshiftObserverNotificationStatusReference;
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-arczonalshift-autoshiftobservernotificationstatus.html
 */
export interface CfnAutoshiftObserverNotificationStatusProps {
    /**
 ...
 * @stability experimental
 */
export interface IZonalAutoshiftConfigurationRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnZonalAutoshiftConfiguration extends cdk.CfnResource implements cdk.IInspectable, IZonalAutoshiftConfigurationRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    ...
    get zonalAutoshiftConfigurationRef(): ZonalAutoshiftConfigurationReference;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
