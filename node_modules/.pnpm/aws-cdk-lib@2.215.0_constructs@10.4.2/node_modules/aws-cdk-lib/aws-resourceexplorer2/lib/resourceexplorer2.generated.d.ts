 ...
 */
export interface IDefaultViewAssociationRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnDefaultViewAssociation extends cdk.CfnResource implements cdk.IInspectable, IDefaultViewAssociationRef {
    /**
    ...
    get defaultViewAssociationRef(): DefaultViewAssociationReference;
 ...
 */
export declare class CfnIndex extends cdk.CfnResource implements cdk.IInspectable, IIndexRef, cdk.ITaggable {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
 ...
 */
export declare class CfnView extends cdk.CfnResource implements cdk.IInspectable, IViewRef, cdk.ITaggable {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
