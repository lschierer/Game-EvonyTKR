 ...
 */
export declare class CfnIdentitySource extends cdk.CfnResource implements cdk.IInspectable, IIdentitySourceRef {
    /**
 ...
 * @stability experimental
 */
export interface IPolicyStoreRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnPolicyStore extends cdk.CfnResource implements cdk.IInspectable, IPolicyStoreRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
     ...
     */
    deletionProtection?: CfnPolicyStore.DeletionProtectionProperty | cdk.IResolvable;
    /**
    ...
    get policyStoreRef(): PolicyStoreReference;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export interface CfnPolicyStoreProps {
     ...
     */
    readonly deletionProtection?: CfnPolicyStore.DeletionProtectionProperty | cdk.IResolvable;
    /**
     * Descriptive text that you can provide to help with identification of the current policy store.
     *
 ...
 * @stability experimental
 */
export interface IPolicyTemplateRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnPolicyTemplate extends cdk.CfnResource implements cdk.IInspectable, IPolicyTemplateRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    ...
    get policyTemplateRef(): PolicyTemplateReference;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
