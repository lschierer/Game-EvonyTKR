 ...
 */
export interface IApplicationV2Ref extends constructs.IConstruct {
    /**
     * A reference to a Application resource.
     */
    readonly applicationRef: ApplicationV2Reference;
}
/**
 ...
 */
export declare class CfnApplicationV2 extends cdk.CfnResource implements cdk.IInspectable, IApplicationV2Ref, cdk.ITaggable {
    /**
    ...
    get applicationRef(): ApplicationV2Reference;
...
export declare namespace CfnApplicationV2 {
    ...
    interface ApplicationConfigurationProperty {
         ...
         */
        readonly applicationEncryptionConfiguration?: CfnApplicationV2.ApplicationEncryptionConfigurationProperty | cdk.IResolvable;
        /**
 ...
 * @stability external
 */
export interface ApplicationV2Reference {
    /**
 ...
 * @stability experimental
 */
export interface IApplicationCloudWatchLoggingOptionV2Ref extends constructs.IConstruct {
    /**
     * A reference to a ApplicationCloudWatchLoggingOption resource.
     */
    readonly applicationCloudWatchLoggingOptionRef: ApplicationCloudWatchLoggingOptionV2Reference;
}
/**
 ...
 */
export declare class CfnApplicationCloudWatchLoggingOptionV2 extends cdk.CfnResource implements cdk.IInspectable, IApplicationCloudWatchLoggingOptionV2Ref {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    ...
    get applicationCloudWatchLoggingOptionRef(): ApplicationCloudWatchLoggingOptionV2Reference;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
 ...
 * @stability external
 */
export interface ApplicationCloudWatchLoggingOptionV2Reference {
    /**
 ...
 * @stability experimental
 */
export interface IApplicationOutputV2Ref extends constructs.IConstruct {
    /**
     * A reference to a ApplicationOutput resource.
     */
    readonly applicationOutputRef: ApplicationOutputV2Reference;
}
/**
 ...
 */
export declare class CfnApplicationOutputV2 extends cdk.CfnResource implements cdk.IInspectable, IApplicationOutputV2Ref {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    ...
    get applicationOutputRef(): ApplicationOutputV2Reference;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
 ...
 * @stability external
 */
export interface ApplicationOutputV2Reference {
    /**
 ...
 * @stability experimental
 */
export interface IApplicationReferenceDataSourceV2Ref extends constructs.IConstruct {
    /**
     * A reference to a ApplicationReferenceDataSource resource.
     */
    readonly applicationReferenceDataSourceRef: ApplicationReferenceDataSourceV2Reference;
}
/**
 ...
 */
export declare class CfnApplicationReferenceDataSourceV2 extends cdk.CfnResource implements cdk.IInspectable, IApplicationReferenceDataSourceV2Ref {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    ...
    get applicationReferenceDataSourceRef(): ApplicationReferenceDataSourceV2Reference;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
 ...
 * @stability external
 */
export interface ApplicationReferenceDataSourceV2Reference {
    /**
