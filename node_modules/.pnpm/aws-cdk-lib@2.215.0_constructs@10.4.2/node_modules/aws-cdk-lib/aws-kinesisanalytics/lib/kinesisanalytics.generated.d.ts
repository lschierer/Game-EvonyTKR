 ...
 */
export declare class CfnApplication extends cdk.CfnResource implements cdk.IInspectable, IApplicationRef {
    /**
 ...
 * @stability experimental
 */
export interface IApplicationOutputRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnApplicationOutput extends cdk.CfnResource implements cdk.IInspectable, IApplicationOutputRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
     ...
     */
    output: cdk.IResolvable | CfnApplicationOutput.OutputProperty;
    /**
     * @param scope Scope in which this resource is defined
     * @param id Construct identifier for this resource (unique in its scope)
     * @param props Resource properties
    ...
    get applicationOutputRef(): ApplicationOutputReference;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
 ...
 * @stability experimental
 */
export interface IApplicationReferenceDataSourceRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnApplicationReferenceDataSource extends cdk.CfnResource implements cdk.IInspectable, IApplicationReferenceDataSourceRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
     ...
     */
    referenceDataSource: cdk.IResolvable | CfnApplicationReferenceDataSource.ReferenceDataSourceProperty;
    /**
     * @param scope Scope in which this resource is defined
     * @param id Construct identifier for this resource (unique in its scope)
     * @param props Resource properties
    ...
    get applicationReferenceDataSourceRef(): ApplicationReferenceDataSourceReference;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
