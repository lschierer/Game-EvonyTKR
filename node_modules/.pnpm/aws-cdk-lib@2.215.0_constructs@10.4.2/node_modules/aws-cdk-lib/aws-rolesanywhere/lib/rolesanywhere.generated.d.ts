 ...
 */
export interface ICRLRef extends constructs.IConstruct {
    /**
...
export declare class CfnProfile extends cdk.CfnResource implements cdk.IInspectable, IProfileRef, cdk.ITaggable {
     ...
     */
    acceptRoleSessionName?: boolean | cdk.IResolvable;
    /**
 ...
 * @stability experimental
 */
export interface ITrustAnchorRef extends constructs.IConstruct {
    /**
