...
export declare class CfnApplication extends cdk.CfnResource implements cdk.IInspectable, IApplicationRef, cdk.ITaggable {
     ...
     */
    applicationConfiguration?: CfnApplication.ApplicationConfigurationProperty | cdk.IResolvable;
    /**
     ...
     */
    applicationMaintenanceConfiguration?: CfnApplication.ApplicationMaintenanceConfigurationProperty | cdk.IResolvable;
    /**
     ...
     */
    runConfiguration?: cdk.IResolvable | CfnApplication.RunConfigurationProperty;
    /**
...
export declare namespace CfnApplication {
    ...
    interface ApplicationConfigurationProperty {
         ...
         */
        readonly applicationEncryptionConfiguration?: CfnApplication.ApplicationEncryptionConfigurationProperty | cdk.IResolvable;
        /**
         ...
         */
        readonly applicationSystemRollbackConfiguration?: CfnApplication.ApplicationSystemRollbackConfigurationProperty | cdk.IResolvable;
        /**
 ...
 * @stability experimental
 */
export interface IApplicationCloudWatchLoggingOptionRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnApplicationCloudWatchLoggingOption extends cdk.CfnResource implements cdk.IInspectable, IApplicationCloudWatchLoggingOptionRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnApplicationCloudWatchLoggingOption;
    /**
     ...
     */
    cloudWatchLoggingOption: CfnApplicationCloudWatchLoggingOption.CloudWatchLoggingOptionProperty | cdk.IResolvable;
    /**
     * @param scope Scope in which this resource is defined
     * @param id Construct identifier for this resource (unique in its scope)
     * @param props Resource properties
    ...
    get applicationCloudWatchLoggingOptionRef(): ApplicationCloudWatchLoggingOptionReference;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare namespace CfnApplicationCloudWatchLoggingOption {
    /**
     * Provides a description of Amazon CloudWatch logging options, including the log stream Amazon Resource Name (ARN).
     *
     * @struct
