 ...
 */
export interface ICanaryRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnCanary extends cdk.CfnResource implements cdk.IInspectable, ICanaryRef, cdk.ITaggable {
    /**
     ...
     */
    browserConfigs?: Array<CfnCanary.BrowserConfigProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
     ...
     */
    dryRunAndUpdate?: boolean | cdk.IResolvable;
    /**
     ...
     */
    visualReferences?: Array<cdk.IResolvable | CfnCanary.VisualReferenceProperty> | cdk.IResolvable;
    /**
...
export declare namespace CfnCanary {
    ...
    interface CodeProperty {
         ...
         */
        readonly dependencies?: Array<CfnCanary.DependencyProperty | cdk.IResolvable> | cdk.IResolvable;
        /**
    ...
    interface ScheduleProperty {
         ...
         */
        readonly retryConfig?: cdk.IResolvable | CfnCanary.RetryConfigProperty;
    }
    /**
     * The canary's retry configuration information.
     *
...
export interface CfnCanaryProps {
     ...
     */
    readonly browserConfigs?: Array<CfnCanary.BrowserConfigProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
     * Use this structure to input your script code for the canary.
     *
     * This structure contains the Lambda handler with the location where the canary should start running the script. If the script is stored in an S3 bucket, the bucket name, key, and version are also included. If the script is passed into the canary directly, the script code is contained in the value of `Script` .
     ...
     */
    readonly dryRunAndUpdate?: boolean | cdk.IResolvable;
    /**
     * The ARN of the IAM role to be used to run the canary.
     *
     ...
     */
    readonly visualReferences?: Array<cdk.IResolvable | CfnCanary.VisualReferenceProperty> | cdk.IResolvable;
    /**
     * If this canary is to test an endpoint in a VPC, this structure contains information about the subnet and security groups of the VPC endpoint.
     *
     * For more information, see [Running a Canary in a VPC](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch_Synthetics_Canaries_VPC.html) .
