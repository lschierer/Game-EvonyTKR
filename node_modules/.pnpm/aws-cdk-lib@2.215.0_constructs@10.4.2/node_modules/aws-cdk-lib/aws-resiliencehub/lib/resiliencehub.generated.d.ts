 ...
 * @stability experimental
 */
export interface IResiliencyPolicyRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnResiliencyPolicy extends cdk.CfnResource implements cdk.IInspectable, IResiliencyPolicyRef, cdk.ITaggable {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    ...
    get resiliencyPolicyRef(): ResiliencyPolicyReference;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
