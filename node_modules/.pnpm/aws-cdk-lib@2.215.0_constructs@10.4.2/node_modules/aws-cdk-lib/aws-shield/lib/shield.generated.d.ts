 ...
 */
export interface IDRTAccessRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnDRTAccess extends cdk.CfnResource implements cdk.IInspectable, IDRTAccessRef {
    /**
    ...
    get drtAccessRef(): DRTAccessReference;
 ...
 * @stability experimental
 */
export interface IProactiveEngagementRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnProactiveEngagement extends cdk.CfnResource implements cdk.IInspectable, IProactiveEngagementRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    ...
    get proactiveEngagementRef(): ProactiveEngagementReference;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
 ...
 * @stability experimental
 */
export interface IProtectionRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnProtection extends cdk.CfnResource implements cdk.IInspectable, IProtectionRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    ...
    get protectionRef(): ProtectionReference;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
 ...
 * @stability experimental
 */
export interface IProtectionGroupRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnProtectionGroup extends cdk.CfnResource implements cdk.IInspectable, IProtectionGroupRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    ...
    get protectionGroupRef(): ProtectionGroupReference;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
