 ...
 * @stability experimental
 */
export interface IEventDataStoreRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnEventDataStore extends cdk.CfnResource implements cdk.IInspectable, IEventDataStoreRef, cdk.ITaggable {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
     ...
     */
    contextKeySelectors?: Array<CfnEventDataStore.ContextKeySelectorProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
    ...
    get eventDataStoreRef(): EventDataStoreReference;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export interface CfnEventDataStoreProps {
     ...
     */
    readonly contextKeySelectors?: Array<CfnEventDataStore.ContextKeySelectorProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
     * Indicates if [Lake query federation](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/query-federation.html) is enabled. By default, Lake query federation is disabled. You cannot delete an event data store if Lake query federation is enabled.
     *
 ...
 * @stability experimental
 */
export interface ITrailRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnTrail extends cdk.CfnResource implements cdk.IInspectable, ITrailRef, cdk.ITaggable {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
 ...
 */
export declare class CfnDashboard extends cdk.CfnResource implements cdk.IInspectable, IDashboardRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
