 ...
 */
export interface IPermissionRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnPermission extends cdk.CfnResource implements cdk.IInspectable, IPermissionRef, cdk.ITaggable {
    /**
    ...
    get permissionRef(): PermissionReference;
 ...
 * @stability experimental
 */
export interface IResourceShareRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnResourceShare extends cdk.CfnResource implements cdk.IInspectable, IResourceShareRef, cdk.ITaggable {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    ...
    get resourceShareRef(): ResourceShareReference;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
