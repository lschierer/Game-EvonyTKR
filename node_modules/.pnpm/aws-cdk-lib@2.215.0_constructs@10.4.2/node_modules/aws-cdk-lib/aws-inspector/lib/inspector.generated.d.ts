 ...
 */
export interface IAssessmentTargetRef extends constructs.IConstruct {
    /**
 ...
 * @stability experimental
 */
export interface IAssessmentTemplateRef extends constructs.IConstruct {
    /**
 ...
 * @stability experimental
 */
export interface IResourceGroupRef extends constructs.IConstruct {
    /**
