 ...
 * @stability experimental
 */
export interface IStreamProcessorRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnStreamProcessor extends cdk.CfnResource implements cdk.IInspectable, IStreamProcessorRef, cdk.ITaggable {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    ...
    get streamProcessorRef(): StreamProcessorReference;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
