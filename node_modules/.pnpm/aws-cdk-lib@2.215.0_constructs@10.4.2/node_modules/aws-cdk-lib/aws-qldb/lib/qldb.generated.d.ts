 ...
 */
export interface ILedgerRef extends constructs.IConstruct {
    /**
 ...
 */
export declare class CfnLedger extends cdk.CfnResource implements cdk.IInspectable, ILedgerRef, cdk.ITaggable {
    /**
 ...
 * @stability experimental
 */
export interface IStreamRef extends constructs.IConstruct {
    /**
...
export declare class CfnStream extends cdk.CfnResource implements cdk.IInspectable, IStreamRef, cdk.ITaggable {
     ...
     */
    kinesisConfiguration: cdk.IResolvable | CfnStream.KinesisConfigurationProperty;
    /**
