...
the instance image used has reached EOL on Dec 31 2023`)}catch(error){throw process.env.JSII_DEBUG!=="1"&&error.name==="DeprecationError"&&Error.captureStackTrace(error,jsiiDeprecationWarnings().getPropertyDescriptor(this,"securityGroup").get),error}if(!this._securityGroup)throw new(core_1()).UnscopedValidationError("Pass the NatInstanceProvider to a Vpc before accessing 'securityGroup'");return this._securityGroup}get connections(){try{jsiiDeprecationWarnings().print("aws-cdk-lib.aws_ec2.NatInstanceProvider#connections",`use NatInstanceProviderV2. NatInstanceProvider is deprecated since
the instance image used has reached EOL on Dec 31 2023`)}catch(error){throw process.env.JSII_DEBUG!=="1"&&error.name==="DeprecationError"&&Error.captureStackTrace(error,jsiiDeprecationWarnings().getPropertyDescriptor(this,"connections").get),error}if(!this._connections)throw new(core_1()).UnscopedValidationError("Pass the NatInstanceProvider to a Vpc before accessing 'connections'");return this._connections}get configuredGateways(){try{jsiiDeprecationWarnings().print("aws-cdk-lib.aws_ec2.NatInstanceProvider#configuredGateways",`use NatInstanceProviderV2. NatInstanceProvider is deprecated since
