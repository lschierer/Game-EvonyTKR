...
diag 'start of David Farragut Ascending Attributes';

subtest 'David Farragut Ascending Attributes' => sub {

  subtest '1 Star' => sub {
    my $text = 'Enemy Ranged Troop and Siege Machines Defense and HP -10%.';
    my $hb   = testText($text);
