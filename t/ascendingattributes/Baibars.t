...
diag 'start of Baibars Ascending Attributes';

subtest 'Baibars Ascending Attributes' => sub {

  subtest '1 Star' => sub {
    my $text = 'When attacking Monsters, Troops Defense +5% and HP +10%.';
    my $hb   = testText($text);
    ...
    ok(
      ...
      '5% Defense buff (Against Monsters)'
    );
  ...
  subtest '2 Star' => sub {
    my $text = 'When attacking Monsters, Troops Defense +20%.';
    my $hb   = testText($text);
    ...
    ok(
      ...
      '20% Defense buff (Against Monsters)'
    );
