...
diag 'start of Champlain Ascending Attributes';

subtest 'Champlain Ascending Attributes' => sub {

  subtest '1 Star' => sub {
    my $text = 'Siege Machine Attack +10% and HP +10%';
    my $hb   = testText($text);
  ...
  subtest '3 Star' => sub {
    my $text = 'Ranged Troop and Siege Machine Attack +15% and Defense +15%';
    my $hb   = testText($text);
  ...
  subtest '4 Star' => sub {
    my $text = 'Siege Machine Attack +20% and HP +20%';
    my $hb   = testText($text);
