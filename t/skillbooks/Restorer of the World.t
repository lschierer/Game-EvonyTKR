...
diag 'start of Restorer of the World Skill Book';
subtest 'Restorer of the World Skill Book' => sub {
  my $text = "Increases ground troops’ attack by 40% and increases ground troops and mounted troops’ HP by 35% when General is leading the army to attack.";
  ...
  ok(
    ...
    '40% Ground Troops Attack buff (leading the army, Attacking)'
  );
  ...
  ok(
    ...
    '35% Ground Troops HP buff (leading the army, Attacking)'
  );
  ...
  ok(
    ...
    '35% Mounted Troops HP buff (leading the army, Attacking)'
  );
