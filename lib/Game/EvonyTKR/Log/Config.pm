...
package Game::EvonyTKR::Log::Config {
  ...
  sub logLevels {
    return {
      ...
      'Game::EvonyTKR::Controller::Role::AscendingAttributes' => 'DEBUG',
      ...
      'Game::EvonyTKR::External::General::Pair::CreatePairs'       => 'INFO',
      ...
      'Game::EvonyTKR::Model::AscendingAttributes'                 => 'DEBUG',
