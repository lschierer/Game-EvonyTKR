...
class Game::EvonyTKR::Buff::Data::EvaluationData::Mayor {
  use Carp;
  use Types::Common qw( t is_Num is_Str is_Int);
  use Type::Utils "is";
  use namespace::autoclean;
# PODNAME: Game::EvonyTKR::Buff::Data::EvaluationData::Mayor
...
=cut
  ...
  ADJUST {
    ...
    $pNum->check($GenericAttack)
      or push @errors =>
      "GenericAttack must be a Positive Number, not $GenericAttack";
...
=cut
  ...
  ADJUST {
    my @errors;
    my $pNum = t('PositiveOrZeroNum');
    $pNum->check($SiegeAttack)
      or push @errors =>
      "SiegeAttack must be a Positive Number, not $SiegeAttack";
    my $range = t('IntRange[0, 10]');
    $range->check($SiegeAttack)
      or push @errors =>
      "SiegeAttack must be within the range 0-10 inclusive, not $SiegeAttack";
    if (@errors) {
      croak join ', ' => @errors;
    }
  }
...
=cut
  ...
  ADJUST {
    my @errors;
    my $pNum = t('PositiveOrZeroNum');
    $pNum->check($GenericDefense)
      or push @errors =>
      "GenericDefense must be a Positive Number, not $GenericDefense";
    my $range = t('IntRange[0, 10]');
...
=cut
  ...
  ADJUST {
    my @errors;
    my $pNum = t('PositiveOrZeroNum');
    $pNum->check($SiegeDefense)
      or push @errors =>
      "SiegeDefense must be a Positive Number, not $SiegeDefense";
    my $range = t('IntRange[0, 10]');
    $range->check($SiegeDefense)
      or push @errors =>
      "SiegeDefense must be within the range 0-10 inclusive, not $SiegeDefense";
    if (@errors) {
      croak join ', ' => @errors;
    }
  }
...
=cut
  ...
  ADJUST {
    my @errors;
    my $pNum = t('PositiveOrZeroNum');
    $pNum->check($GenericHP)
      or push @errors => "GenericHP must be a Positive Number, not $GenericHP";
    my $range = t('IntRange[0, 10]');
    $range->check($GenericHP)
      or push @errors =>
      "GenericHP must be within the range 0-10 inclusive, not $GenericHP";
    if (@errors) {
      croak join ', ' => @errors;
    }
  }
...
=cut
  ...
  ADJUST {
    ...
    my $pNum = t('PositiveOrZeroNum');
    $pNum->check($SiegeHP)
      or push @errors => "SiegeHP must be a Positive Number, not $SiegeHP";
    my $range = t('IntRange[0, 10]');
    $range->check($SiegeHP)
      or push @errors =>
      "SiegeHP must be within the range 0-10 inclusive, not $SiegeHP";
    if (@errors) {
      croak join ', ' => @errors;
    }
  }
...
=cut
  ...
  ADJUST {
    my @errors;
    my $pNum = t('PositiveOrZeroNum');
    $pNum->check($MarchSizeIncrease)
      or push @errors =>
      "MarchSizeIncrease must be a Positive Number, not $MarchSizeIncrease";
    my $range = t('IntRange[0, 10]');
...
=cut
  ...
  ADJUST {
    my @errors;
    my $pNum = t('PositiveOrZeroNum');
    $pNum->check($RallySizeIncrease)
      or push @errors =>
      "RallySizeIncrease must be a Positive Number, not $RallySizeIncrease";
    my $range = t('IntRange[0, 10]');
...
=cut
  ...
  ADJUST {
    my @errors;
    my $pNum = t('PositiveOrZeroNum');
    $pNum->check($GenericAttackDebuff)
      or push @errors =>
      "GenericAttackDebuff must be a Positive Number, not $GenericAttackDebuff";
    my $range = t('IntRange[0, 10]');
...
=cut
  ...
  ADJUST {
    my @errors;
    my $pNum = t('PositiveOrZeroNum');
    $pNum->check($GroundAttackDebuff)
      or push @errors =>
      "GroundAttackDebuff must be a Positive Number, not $GroundAttackDebuff";
    my $range = t('IntRange[0, 10]');
...
=cut
  ...
  ADJUST {
    my @errors;
    my $pNum = t('PositiveOrZeroNum');
    $pNum->check($MountedAttackDebuff)
      or push @errors =>
      "MountedAttackDebuff must be a Positive Number, not $MountedAttackDebuff";
    my $range = t('IntRange[0, 10]');
...
=cut
  ...
  ADJUST {
    my @errors;
    my $pNum = t('PositiveOrZeroNum');
    $pNum->check($RangedAttackDebuff)
      or push @errors =>
      "RangedAttackDebuff must be a Positive Number, not $RangedAttackDebuff";
    my $range = t('IntRange[0, 10]');
...
=cut
  ...
  ADJUST {
    my @errors;
    my $pNum = t('PositiveOrZeroNum');
    $pNum->check($SiegeAttackDebuff)
      or push @errors =>
      "SiegeAttackDebuff must be a Positive Number, not $SiegeAttackDebuff";
    my $range = t('IntRange[0, 10]');
...
=cut
  ...
  ADJUST {
    my @errors;
    my $pNum = t('PositiveOrZeroNum');
    $pNum->check($GroundDefenseDebuff)
      or push @errors =>
      "GroundDefenseDebuff must be a Positive Number, not $GroundDefenseDebuff";
    my $range = t('IntRange[0, 10]');
...
=cut
  ...
  ADJUST {
    my @errors;
    my $pNum = t('PositiveOrZeroNum');
    $pNum->check($RangedDefenseDebuff)
      or push @errors =>
      "RangedDefenseDebuff must be a Positive Number, not $RangedDefenseDebuff";
    my $range = t('IntRange[0, 10]');
...
=cut
  ...
  ADJUST {
    my @errors;
    my $pNum = t('PositiveOrZeroNum');
    $pNum->check($SiegeDefenseDebuff)
      or push @errors =>
      "SiegeDefenseDebuff must be a Positive Number, not $SiegeDefenseDebuff";
    my $range = t('IntRange[0, 10]');
...
=cut
  ...
  ADJUST {
    my @errors;
    my $pNum = t('PositiveOrZeroNum');
    $pNum->check($GenericHPDebuff)
      or push @errors =>
      "GenericHPDebuff must be a Positive Number, not $GenericHPDebuff";
    my $range = t('IntRange[0, 10]');
...
=cut
  ...
  ADJUST {
    my @errors;
    my $pNum = t('PositiveOrZeroNum');
    $pNum->check($GroundHPDebuff)
      or push @errors =>
      "GroundHPDebuff must be a Positive Number, not $GroundHPDebuff";
    my $range = t('IntRange[0, 10]');
...
=cut
  ...
  ADJUST {
    my @errors;
    my $pNum = t('PositiveOrZeroNum');
    $pNum->check($MountedHPDebuff)
      or push @errors =>
      "MountedHPDebuff must be a Positive Number, not $MountedHPDebuff";
    my $range = t('IntRange[0, 10]');
...
=cut
  ...
  ADJUST {
    my @errors;
    my $pNum = t('PositiveOrZeroNum');
    $pNum->check($RangedHPDebuff)
      or push @errors =>
      "RangedHPDebuff must be a Positive Number, not $RangedHPDebuff";
    my $range = t('IntRange[0, 10]');
...
=cut
  ...
  ADJUST {
    my @errors;
    my $pNum = t('PositiveOrZeroNum');
    $pNum->check($SiegeHPDebuff)
      or push @errors =>
      "SiegeHPDebuff must be a Positive Number, not $SiegeHPDebuff";
    my $range = t('IntRange[0, 10]');
...
=cut
  ...
  ADJUST {
    my @errors;
    my $pNum = t('PositiveOrZeroNum');
    $pNum->check($Death2WoundedDebuff)
      or push @errors =>
      "Death2WoundedDebuff must be a Positive Number, not $Death2WoundedDebuff";
    my $range = t('IntRange[0, 10]');
...
=cut
  ...
  ADJUST {
    my @errors;
    my $pNum = t('PositiveOrZeroNum');
    $pNum->check($Death2SoulsDebuff)
      or push @errors =>
      "Death2SoulsDebuff must be a Positive Number, not $Death2SoulsDebuff";
    my $range = t('IntRange[0, 10]');
