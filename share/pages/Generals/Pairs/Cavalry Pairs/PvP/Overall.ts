...
const getFrontmatter: GetFrontmatter = async (
  ...
  cf.title = "Generic Cavalry Generals Comparison";
  return cf;
};
...
export default class AttackingCavComparison extends GeneralComparisonPage {
  ...
  protected override pageDescription = () => {
    return `This allows you to compare the relative buffs of the Cavalry Generals during player-versus-player situations where only generic buffs are active.`;
  };
}
