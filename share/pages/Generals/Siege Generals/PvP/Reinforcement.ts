...
const getFrontmatter: GetFrontmatter = async (
  ...
  cf.title = "Reinforcement Siege Generals Comparison";
  return cf;
};
...
export default class AttackingCavComparison extends GeneralComparisonPage {
  ...
  protected override pageDescription = () => {
    return `This allows you to compare the relative buffs of the Siege Generals during player-versus-player situations where you are reinforcing another keep.`;
  };
}
