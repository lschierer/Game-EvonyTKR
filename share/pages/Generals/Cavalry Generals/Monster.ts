...
const getFrontmatter: GetFrontmatter = async (
  ...
  cf.title = "Monster Hunting Cavalry Generals Comparison";
  return cf;
};
...
export default class AttackingCavComparison extends GeneralComparisonPage {
  constructor() {
    super();
    super.buffFilterChanged("monster");
    super.generalType = Constants.GeneralType.Enum.mounted_specialist;
  }

  protected override pageDescription = () => {
    return `This allows you to compare the relative buffs of the Cavalry Generals during player-versus-monster situations where you are hunting.`;
  };
}
