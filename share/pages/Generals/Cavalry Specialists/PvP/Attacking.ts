...
const getFrontmatter: GetFrontmatter = async (
  ...
  cf.title = "Attacking Cavalry Generals Comparison";
  return cf;
};
...
export default class AttackingCavComparison extends GeneralComparisonPage {
  constructor() {
    super();
    super.buffFilterChanged("attack");
    super.generalType = Constants.GeneralType.Enum.mounted_specialist;
  }

  protected override pageDescription = () => {
    return `This allows you to compare the relative buffs of the Cavalry Generals during player-versus-player situations where your 'Attacking' or 'Marching' buffs are active.`;
  };
}
