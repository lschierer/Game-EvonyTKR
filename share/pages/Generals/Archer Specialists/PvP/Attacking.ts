...
const getFrontmatter: GetFrontmatter = async (
  ...
  cf.title = "Attacking Archers Generals Comparison";
  return cf;
};
...
export default class AttackingCavComparison extends GeneralComparisonPage {
  ...
  protected override pageDescription = () => {
    return `This allows you to compare the relative buffs of the Archers Generals during player-versus-player situations where your 'Attacking' or 'Marching' buffs are active.`;
  };
}
