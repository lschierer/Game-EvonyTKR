...
const getFrontmatter: GetFrontmatter = async (
  ...
  cf.title = "Attacking Siege Generals Comparison";
  return cf;
};
...
export default class AttackingCavComparison extends GeneralComparisonPage {
  constructor() {
    ...
    super.generalType = Constants.GeneralType.Enum.siege_specialist;
  }

  protected override pageDescription = () => {
    return `This allows you to compare the relative buffs of the Siege Generals during player-versus-player situations where your 'Attacking' or 'Marching' buffs are active.`;
  };
}
