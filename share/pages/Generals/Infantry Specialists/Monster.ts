...
const getFrontmatter: GetFrontmatter = async (
  ...
  cf.title = "Monster Hunting Infantry Generals Comparison";
  return cf;
};
...
export default class AttackingCavComparison extends GeneralComparisonPage {
  ...
  protected override pageDescription = () => {
    return `This allows you to compare the relative buffs of the Infantry Generals during player-versus-monster situations where you are hunting.`;
  };
}
